...
function Skills() {
  ...
  return (
    <div className={darkMode ? 'dark bg-black ' : ''}>
        <div className='flex justify-between xs:pt-[150px]  container mx-auto items-center mb-[60px]  flex-col '>
        ...
        <div className='flex items-center justify-center flex-wrap'>
            <motion.div initial="hidden" animate="visible" variants={item} className='w-[130px] xs:w-[100px] sm:w-[100px] md:w-[170px] lg:w-[130px] xl:w-[130px] 2xl:w-[130px] m-[5px] flex items-center justify-center flex-col h-[100px] border hover:shadow-xl hover:border-orange-600 hover:shadow-orange-600  border-black '><FaHtml5 className='html text-5xl' /> <p className='font-semibold text-sm mt-1 dark:text-zinc-300'>HTML</p> </motion.div>
            ...
            <div className='flex items-center justify-center flex-wrap'>
            <motion.div initial="hidden" animate="visible" variants={item} className='w-[130px] xs:w-[100px] md:w-[170px] lg:w-[130px] xl:w-[130px] 2xl:w-[130px]  m-[5px] flex items-center justify-center flex-col h-[100px] border border-black hover:shadow-xl hover:shadow-cyan-600 hover:border-cyan-600 '><RiTailwindCssFill className='tailwind text-5xl' /><p className='font-semibold text-sm mt-1 dark:text-zinc-300'>TailwindCss</p></motion.div>
            ...
            <motion.div initial="hidden" animate="visible" variants={item} className='w-[130px] xs:w-[100px] sm:w-[100px] md:w-[170px] lg:w-[130px] xl:w-[130px] 2xl:w-[130px] flex items-center m-[5px] justify-center flex-col h-[100px] border border-black hover:shadow-xl hover:shadow-orange-600 hover:border-orange-600 '><FaGit className='git text-5xl'  /><p className='font-semibold text-sm mt-1 dark:text-zinc-300'>Git</p></motion.div>
            ...
            <motion.div initial="hidden" animate="visible" variants={item} className='w-[130px] xs:w-[100px] sm:w-[100px] md:w-[170px]   m-[5px] flex items-center justify-center flex-col h-[100px] border border-black hover:shadow-xl hover:shadow-blue-600  hover:border-blue-600 '><SiVisualstudiocode className='vsc text-5xl' /><p className='font-semibold text-sm mt-1 dark:text-zinc-300 '>VSC</p></motion.div>
            </div>
