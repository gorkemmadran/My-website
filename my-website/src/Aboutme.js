...
function Aboutme() {
  ...
  return (
    <section className={darkMode ? 'dark bg-black duration-700  ' : ''}>
        ...
        <div className='flex items-center dark:text-gray-200 mt-4'><p className='font-bold text-lg mr-[7px]'>Social :</p><FaSquareGithub className='mr-[10px] text-xl rounded-full' /> <FaLinkedin className='mr-[7px] cursor-pointer text-xl rounded-full' /> <FaTwitter className='mr-[7px] cursor-pointer text-xl rounded-full' /> <FaInstagramSquare className='mr-[7px] cursor-pointer text-xl rounded-full' />
  </div>
        </div>
        </div>
